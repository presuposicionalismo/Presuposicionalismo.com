...
function oe(e) {
  for (const t of e.scripts)
    !t.hasAttribute("data-astro-rerun") && q(t) && (t.dataset.astroExec = "");
}
function re(e) {
...
async function be(e, t, n, o, r, i, u, a, c) {
  ...
  return (
    document.dispatchEvent(d) &&
      (await d.loader(),
      d.defaultPrevented ||
        (pe(me), d.navigationType !== "traverse" && D({ scrollX, scrollY }))),
    d
  );
}
...
async function C(e, t, n, o, r) {
  async function i(d) {
    function l(f) {
      const w = f.effect;
      return !w || !(w instanceof KeyframeEffect) || !w.target
        ? !1
        : window.getComputedStyle(w.target, w.pseudoElement)
...
async function J(e, t, n, o, r) {
  ...
  async function c(s) {
    ...
    if (s.formData) {
      ...
      b.body =
        t !== void 0 &&
        Reflect.get(HTMLFormElement.prototype, "attributes", p).getNamedItem(
          "enctype",
    ...
    if (
      ((F ??= new DOMParser()),
      (s.newDocument = F.parseFromString(f.html, f.mediaType)),
      s.newDocument.querySelectorAll("noscript").forEach((p) => p.remove()),
...
function xe() {
  ...
  N(() => {
    for (const t of document.getElementsByTagName("a"))
      E.has(t) || (T(t, "viewport") && (E.add(t), (e ??= Ie()), e.observe(t)));
  });
}
function Ie() {
  const e = new WeakMap();
...
(x || He() !== "none") &&
  ...
  document.addEventListener("submit", (e) => {
    ...
    const n = e.submitter,
      o = n && n === A;
    if (((A = null), t.tagName !== "FORM" || e.defaultPrevented || B(t) || o))
      return;
    const r = t,
      i = new FormData(r, n),
