...
heroImage: "/src/assets/coverblog/2021-09-01.webp"
tags:
  - "presuposicionalismo"
  - "neutralidad"
  - "apologetica"
  - "van-til"
  - "presuposicionalismo-y-evidencia"
  - "original"
  - "respuesta-polemica"
seoDescription: "El presuposicionalismo no descarta la evidencia: la interpreta siempre a la luz de la cosmovisión cristiana y la revelación divina."
---
...
Pallmann identifica a algunos de estos cristianos con los presuposicionalistas: _"Hablo particularmente de los presuposicionalistas. Sin embargo, argumentos similares son comunes entre diversos críticos de la apologética. Tales argumentos no son exclusivos de los presuposicionalistas."_[^3]
...
[^2]: [https://crossexamined.org/es-la-biblia-nuestra-principal-autoridad/](https://crossexamined.org/es-la-biblia-nuestra-principal-autoridad/)
[^3]: [https://crossexamined.org/es-la-biblia-nuetra-principal-autoridad/#\_ftn1](https://crossexamined.org/es-la-biblia-nuetra-principal-autoridad/#_ftn1)
...
[^12]: Dennis MacCullum en su libro _Christianity: The Faith That Makes Sense_ (Wheaton, Ill.: Tyndale House, 1992) sostiene esta opinión: "Si somos justos, adoptaremos una postura **_neutral_** a la hora de determinar en qué creer" (11 \[énfasis añadido\]).
[^13]: Para un excelente tratamiento de cómo utilizar las pruebas dentro de un marco presuposicional, véase Thom Notaro, _Van Til and the Use of Evidence_ (Phillipsburg, N.J.: Presbyterian and Reformed, 1980).
[^14]: Frame, _Apologetics to the Glory of God_ (Phillipsburg, N.J.: Presbyterian and Reformed, 1994) 21.
